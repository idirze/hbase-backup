...
import org.apache.hadoop.hbase.backup.hbase1_2_1.impl.BackupSystemTable.WALItem;
...
import static org.apache.hadoop.hbase.backup.hbase1_2_1.util.AbstractFSWALProviderUtils.isMetaFile;
...
public class IncrementalBackupManager extends BackupManager {
    ...
    private List<String> excludeAlreadyBackedUpWALs(List<String> logList,
        ...
        for (int i = 0; i < logList.size(); i++) {
            ...
            if (walFileNameSet.contains(name) || name.startsWith(LOG_PREFIX)) {
                continue;
            }
